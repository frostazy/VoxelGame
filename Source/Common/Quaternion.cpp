...
void HyVoxel::Algebra::Quaternion_loadIdentity(Quaternion * quaternion)
{
	quaternion->x = 0.0f;
	quaternion->y = 0.0f;
	quaternion->z = 0.0f;
...
Quaternion HyVoxel::Algebra::Quaternion_identity()
{
...
Quaternion HyVoxel::Algebra::Quaternion_withValues(float x, float y, float z, float w)
{
	Quaternion quaternion;
...
Quaternion HyVoxel::Algebra::Quaternion_fromVector(Vector vector)
{
	Quaternion quaternion;
...
Vector HyVoxel::Algebra::Quaternion_toVector(Quaternion quaternion)
{
	Vector vector;
...
Quaternion HyVoxel::Algebra::Quaternion_fromAxisAngle(Vector axis, float angle)
{
	Quaternion quaternion;
	float sinAngle;
...
void HyVoxel::Algebra::Quaternion_toAxisAngle(Quaternion quaternion, Vector * axis, float * angle)
{
	float sinAngle;
...
Matrix HyVoxel::Algebra::Quaternion_toMatrix(Quaternion quaternion)
{
	Matrix matrix;
...
void HyVoxel::Algebra::Quaternion_normalize(Quaternion * quaternion)
{
	float magnitude;
...
Quaternion HyVoxel::Algebra::Quaternion_normalized(Quaternion quaternion)
{
	Quaternion_normalize(&quaternion);
	return quaternion;
}

void HyVoxel::Algebra::Quaternion_multiply(Quaternion * quaternion1, Quaternion quaternion2)
{
...
Quaternion HyVoxel::Algebra::Quaternion_multiplied(Quaternion quaternion1, Quaternion quaternion2)
{
...
Quaternion HyVoxel::Algebra::Quaternion_slerp(Quaternion start, Quaternion end, float alpha)
{
...
void HyVoxel::Algebra::Quaternion_rotate(Quaternion * quaternion, Vector axis, float angle)
{
...
Quaternion HyVoxel::Algebra::Quaternion_rotated(Quaternion quaternion, Vector axis, float angle)
{
	Quaternion_rotate(&quaternion, axis, angle);
	return quaternion;
}

void HyVoxel::Algebra::Quaternion_invert(Quaternion * quaternion)
{
	float length;
...
Quaternion HyVoxel::Algebra::Quaternion_inverted(Quaternion quaternion)
{
	Quaternion_invert(&quaternion);
	return quaternion;
}

Vector HyVoxel::Algebra::Quaternion_multiplyVector(Quaternion quaternion, Vector vector)
{
